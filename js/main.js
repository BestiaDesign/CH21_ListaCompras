...
let cantidad = 0;
let idTimeout;
let datos = []; // new Array(); // Nuevo arreglo
...
btnAgregar.addEventListener("click", function(event){
    ...
    if ( (! validarNombre()) || (! validarCantidad() ) ) {
        let lista = "Los campos debes ser llenados correctamente.<ul>";
        if (! validarNombre()) {
            txtNombre.style.border = "red thin solid";
            lista += "<li>Escribe un artículo valido</li>";
        } // if Validar texto

    if (! validarCantidad()) {
        txtNumber.style.border = "red thin solid";
        lista += "<li>Escribe un precio valido</li>";
        } // if Validar texto
